...
def all_in_one(class_id,num_id,lr_sch_size,epoch_num,new_train=True,pretrain_model_epoch = 0,random_crop=True,lr_rate=0.005):
    ...
    def get_fine_tune_model(symbol, arg_params, layer_name='flatten0',new_train=True):
        ...
        net = mx.sym.BlockGrad(data=net,name='block')
        multi_output = []
        for idx, i in enumerate(attr_len):
# The first fully-connected layer and the corresponding activation function
            fc1  = mx.sym.FullyConnected(data=net, num_hidden=1024)
            ...
            net_temp = mx.symbol.FullyConnected(data=act3, num_hidden=i, name='fc_{}'.format(idx))
...
all_in_one(class_id='10001',num_id='3',lr_sch_size=20000,epoch_num=30,pretrain_model_epoch=0,new_train=False,random_crop=False,lr_rate=0.005)

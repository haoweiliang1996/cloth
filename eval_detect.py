...
def eval_res(class_id,num_id,eval_epoch,root_dir = '/home/lhw/face/faceRec'):
    ...
    def do_multi_predict(model_name,batch_size=512,folder_name=folder_name,epoch_num=eval_epoch,tt=1):
        ...
        augs += mx.image.CreateAugmenter(data_shape=(3,longth_, width_),rand_crop=False,rand_resize=False, rand_mirror=True, brightness=0.125, contrast=0.125, rand_gray=0.05,saturation=0.125, pca_noise=0.125, inter_method=10)
        final_res = None
...
eval_res(10001,3,30,'/root/cloth')
